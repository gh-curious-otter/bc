...
// getRecentlyClosedIssues returns the most recently closed issues (up to dashboardMaxClosedIssues).
// It scans from the end of the issues list since issues loaded later tend to be more recently updated.
