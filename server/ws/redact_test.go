...
func TestRedactSecrets_GitHubPAT(t *testing.T) {
	input := `GH_TOKEN="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" gh pr create` //nolint:gosec // test data, not real credentials
...
func TestRedactSecrets_AWSKey(t *testing.T) {
	input := "AWS_ACCESS_KEY_ID=AKIAIOSFODNN7EXAMPLE" //nolint:gosec // test data, not real credentials
	result := RedactSecrets(input)
