    ...
    <main className="min-h-screen selection:bg-primary/20 selection:text-foreground overflow-x-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            {[
              {
                ...
                lines: [
                  ...
                  { text: "Created roles: pm, manager, engineer", color: "text-terminal-muted" },
                  { text: "Channels: #eng, #pr, #standup, #leads", color: "text-terminal-muted" },
              ...
              },
              {
                ...
                lines: [
                  ...
                  { text: "Live mode active.", color: "text-terminal-success" },
                ],
              },
            ].map((s, i) => (
              <div key={s.step}>
                ...
                <TerminalWindow title={`step ${s.step}`}>
                  <CommandOutput command={s.cmd} lines={s.lines} delay={i * 0.2} />
                </TerminalWindow>
                <h3 className="mt-5 mb-2 text-lg font-semibold tracking-tight">{s.title}</h3>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-20">
            <div>
              ...
              <p className="mt-4 text-muted-foreground leading-relaxed">
                The Product Manager sets strategic direction and priorities, while
                Managers break down epics into actionable tasks for the team.
                Engineers execute the implementation work, and QA agents validate
                correctness before merging. Each role operates with scoped
                permissions and distinct memory contexts to prevent conflicts.
              </p>
            ...
            <TerminalWindow title="agent hierarchy" ariaLabel="Agent hierarchy tree showing product-manager, managers, engineers, and QA roles">
              <TreeDiagram
                root={{
                  label: "pm-01",
                  ...
                  children: [
                    {
                      ...
                      state: "working",
                      children: [
                        { label: "eng-01", role: "engineer", state: "working" },
                        { label: "eng-02", role: "engineer", state: "working" },
                    ...
                    },
                    {
                      ...
                      state: "idle",
                      children: [
                        { label: "eng-03", role: "engineer", state: "working" },
        ...
        <RevealSection className="py-16 sm:py-24 lg:py-32" id="channels">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-20">
            <div className="order-2 lg:order-1">
              <TerminalWindow title="#engineering" ariaLabel="Channel view showing agent-to-agent communication in the engineering channel">
                <ChannelView
                  name="engineering"
                  members={3}
                  messages={[
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-4 text-muted-foreground leading-relaxed">
                Agents coordinate through Slack-like channels such as #eng, #pr,
                #standup, and #leads, complete with @mentions and structured
                handoffs between team members. Every interaction is automatically
                logged and fully searchable for audit and debugging purposes.
              </p>
              <div className="mt-6 font-mono text-sm text-muted-foreground">
                <span className="text-[var(--terminal-prompt)]">$ </span>
        ...
        <RevealSection className="py-16 sm:py-24 lg:py-32" id="worktrees">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-20">
            <div>
              ...
              <p className="mt-4 text-muted-foreground leading-relaxed">
                Each agent operates inside its own isolated git worktree, which
                means no agent can step on another&apos;s changes. The result is clean
                pull requests that merge without any conflict, every single time.
              </p>
            </div>
        ...
        <RevealSection className="py-16 sm:py-24 lg:py-32" id="costs">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-20">
            <div className="order-2 lg:order-1">
              <TerminalWindow title="bc cost show" ariaLabel="Cost tracking table showing per-agent token usage, spending, and budget limits">
                <CostTable
                  rows={[
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-4 text-muted-foreground leading-relaxed">
                Every agent has per-token usage tracking with configurable budget
                limits, automatic alerts when spending reaches 80%, and hard stops
                that prevent runaway costs. You will never receive a surprise
                bill from your AI agents again.
              </p>
              <div className="mt-6 font-mono text-sm text-muted-foreground">
                <span className="text-[var(--terminal-prompt)]">$ </span>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-20">
            <div>
              ...
              <p className="mt-4 text-muted-foreground leading-relaxed">
                ...
                carries across sessions and gets automatically injected whenever
                an agent spawns, so context is never lost between runs.
              </p>
            </div>
            <TerminalWindow title="memory: eng-01" ariaLabel="Persistent memory view showing agent learnings and time-stamped experiences">
        ...
        <RevealSection className="pb-16 sm:pb-24 lg:pb-32">
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card shadow-[var(--card-shadow)]">
            ...
            <div className="relative grid items-center gap-8 p-8 sm:p-12 lg:grid-cols-[1fr_auto] lg:gap-16 lg:p-16">
              ...
              <TerminalWindow title="quickstart" className="min-w-[280px]" ariaLabel="Quick start commands: bc init, bc up, bc home">
                <div className="space-y-1.5 text-[13px]">
                  <div><span className="text-terminal-prompt">$ </span>bc init --preset small-team</div>
                  <div><span className="text-terminal-prompt">$ </span>bc up</div>
                  <div><span className="text-terminal-prompt">$ </span>bc home</div>
